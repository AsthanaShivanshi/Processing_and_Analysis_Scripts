...
def interpolate_bilinear_shell(coarse_ds, target_ds, varname):
...
#Splits 
    train_mask = (years >= 1971) & (years <= 2001)
    val_mask   = (years >= 2002) & (years <= 2012)
    test_mask  = (years >= 2013) & (years <= 2023)
