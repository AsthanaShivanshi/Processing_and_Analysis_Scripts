...
parser = argparse.ArgumentParser(description="Spatially Pooled RMSE vs Quantile")
...
plt.ylabel("Spatially pooled RMSE")
plt.title(f"Spatially pooled RMSE vs Quantile threshold for {var} ({file_var})")
plt.legend()
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig(f"{config.OUTPUTS_DIR}/spatially_pooled_rmse_vs_quantile_{var}.png", dpi=500)