...
dotc_bc_path = "/work/FAC/FGSE/IDYST/tbeucler/downscaling/sasthana/Downscaling/Downscaling_Models/BC_Model_Runs/dOTC/dOTC_BC_AllCells_4vars_curvgrid.nc"
dotc_bicubic_path = "/work/FAC/FGSE/IDYST/tbeucler/downscaling/sasthana/Downscaling/Downscaling_Models/BC_Model_Runs/dOTC/precip_temp_tmin_tmax_bicubic_r01.nc"
unet_path = "/work/FAC/FGSE/IDYST/tbeucler/downscaling/sasthana/Downscaling/Downscaling_Models/UNet_Deterministic_Training_Dataset/dOTC_ModelRun_Downscaled_Predictions_Validation_1981_2010.nc"
...
print(f"  dOTC Bias Corrected: {pss_dotc_bc:.3f}")
print(f"  dOTC + Bicubic:   {pss_dotc_bicubic:.3f}")
print(f"  UNet Super Resolved:  {pss_unet:.3f}")



cb_colors = mpl.colormaps['tab10'].colors
...
plt.plot(days, dotc_bc_clim, label=f"dOTC Bias Corrected (PSS={pss_dotc_bc:.2f})", color=cb_colors[2], linewidth=2) # Green
plt.plot(days, dotc_bicubic_clim, label=f"dOTC + Bicubic (PSS={pss_dotc_bicubic:.2f})", color=cb_colors[3], linewidth=2) # Red
