...
plt.xlabel("Quantile threshold",fontsize=18,fontname="Times New Roman")
plt.ylabel(f"RMSE for {args.city} ({args.lat}, {args.lon})",fontsize=18,fontname="Times New Roman")
plt.title(f"RMSE vs Quantile threshold for {args.city} ({var})",fontsize=18,fontname="Times New Roman")
plt.legend(fontsize=12, fontname="Times New Roman")
plt.grid(True, alpha=0.3)
plt.tight_layout(fontsize=18)
plt.savefig(f"{config.OUTPUTS_DIR}/Gridwise/rmse_vs_quantile_{var}_{args.city}.png", dpi=1000)