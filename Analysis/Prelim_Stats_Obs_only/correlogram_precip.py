...
coarse_ds = xr.open_dataset('../../Downscaling_Models/Dataset_Setup_I_Chronological_12km/RhiresD_step2_coarse.nc')["RhiresD"].sel(time=slice("2011-01-01","2023-12-31"))
...
for t in range(n_time):
    ...
    coarse_field = coarse_ds.isel(time=t).values
    ...
    corrs_coarse.append(spatial_correlogram(coarse_field, max_lag=max_lag))
...
plt.title('Mean Spatial Correlogram for Daily Total Precipitation (2011-2023)')
plt.legend()
plt.grid(True)
